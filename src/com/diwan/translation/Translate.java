...
public class Translate {
	...
	public int[] breakSentences(String text, String language)
		...
		try {
			...
			BreakSentencesResponse sentenceLen = stub
	...
	public String[] getTranslations(String text, String from, String to,
			int maxtranslations) throws TranslateFault {
		String[] matches = null;
		if (stub == null)
			throw new TranslateFault("Class not initalized");
		...
		try {
			...
			GetTranslationsResponse0 translationResponse = stub
	...
	public String[] getTranslationsArray(String[] texts, String from,
			String to, int maxtranslations) throws TranslateFault {
		String[] matches = null;
		if (stub == null)
			throw new TranslateFault("Class not initalized");
	...
	public TranslateArrayResponse[] translateArray(String[] texts, String from,
			String to) throws TranslateFault {
		if (stub == null)
			throw new TranslateFault("Class not initalized");
		...
		try {
			...
			TranslateArrayResponse1 translateArrayResponse = stub
					.translateArray(translateArray);
			return translateArrayResponse.getTranslateArrayResult()
